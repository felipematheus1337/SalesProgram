...
public abstract class AirConditioning implements InsuranceTotal {
    ...
    public void input() {
        ...
        System.out.println("What Air conditioning version you want? : ");
        setModel(ent.nextLine());
        System.out.println("How much btu you need ? :");
        setBtu(ent.nextInt());
